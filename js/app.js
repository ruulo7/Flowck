...
function channelIcon(channel, dark) {
  ...
  if (!dark) {
    ...
    if (BRANDED[channel]) {
      return `<span class="ch-icon" title="${BRANDED[channel]}"><img src="assets/icons/${channel}.svg" alt="${BRANDED[channel]}" style="display:block;width:100%;height:100%;"></span>`;
    }
  }
